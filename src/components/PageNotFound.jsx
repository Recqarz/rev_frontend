...
const PageNotFound = () => {
  return (
    <div className="mt-8 w-full flex flex-col lg:flex-row items-center justify-center space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-2xl md:text-4xl lg:text-5xl font-bold tracking-wider text-gray-300">
          404
        </p>
        <p className="text-xl md:text-3xl lg:text-4xl font-bold tracking-wider text-gray-300 mt-2">
          Page Not Found
        </p>
        <p className="text-md md:text-xl lg:text-xl text-gray-500 my-12">
          Oops! The page you’re looking for doesn’t exist.
        </p>
      </div>
      <div className="w-1/2 md:w-1/3 lg:h-full flex lg:items-end justify-center p-4">
        <svg
