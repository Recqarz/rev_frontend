...
const Table = () => {
  const data = [
    ...
    },
    {
      id: '7G',
      name: 'Diana Yellow',
      email: 'dianayellow@gmail.com',
      contact: '555-555-5561',
      status: 'Pending',
    },
    {
      id: '8H',
      ...
      contact: '555-555-5562',
      status: 'Active',
    },
    {
      id: '9I',
      name: 'Frank Red',
      email: 'frankred@gmail.com',
      contact: '555-555-5563',
      status: 'Inactive',
    },
    {
      id: '10J',
      name: 'Grace Pink',
      email: 'gracepink@gmail.com',
      contact: '555-555-5564',
      status: 'Active',
    },
    {
      id: '11K',
      name: 'Harry Orange',
      email: 'harryorange@gmail.com',
      contact: '555-555-5565',
      status: 'Pending',
    },
    {
      id: '12L',
      name: 'Ivy Violet',
      email: 'ivyviolet@gmail.com',
      contact: '555-555-5566',
      status: 'Inactive',
    },
    {
      id: '13M',
      ...
      contact: '555-555-5567',
      status: 'Active',
    },
    {
      id: '14N',
      name: 'Kim Gray',
      email: 'kimgray@gmail.com',
      contact: '555-555-5568',
      status: 'Pending',
    },
    {
      id: '15O',
      name: 'Liam Silver',
      email: 'liamsilver@gmail.com',
      contact: '555-555-5569',
      status: 'Active',
    },
  ]
