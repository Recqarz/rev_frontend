...
import { getSupervisorCaseData } from "../../redux/dashboard/supervisor/supervisor.Action";
...
const SupervisorDashboard = () => {
  ...
  const {data, isLoading} = useSelector((store) => store?.supervisorDashReducer);
...
const supervisorDashboard = [
...

    {
      ...
      link: "/supervisor/allReports",
    }
  ];

useEffect(()=>{
  dispatch(getSupervisorCaseData(accessToken));
},[accessToken]);
